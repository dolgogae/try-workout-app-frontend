...
import LogoPath from '@/assets/nikeLogo.png';
            ...
            <section className={styles.page}>
                <div className={styles.container}>
                    <h1 className={styles.logo}>
                        <Image priority src={LogoPath} alt='logo' width={300}  height={100} />
                    </h1>
                            ...
                            <div>
                                ...
                                >
                                    <div className={styles.socialButton}>
                                        <Image priority src={GoogleLogoPath} alt='googleLogo' width={50}  height={50} />
                                    </div>
                                </Button>
